...
EFFNET_PATH = "model.h5"   

def load_effnet_silent():
    try:
        model = load_model(EFFNET_PATH)
        return model
    except:
        return None
effnet_model = load_effnet_silent()
...
st.markdown("""
<div class="footer">
    <h3>👨‍💻 Developed by Amit Singh</h3>
    <p>Full Stack Developer & AI Enthusiast</p>
    <div class="developer-info">
        <a href="https://www.linkedin.com/in/amit-singh-500825254/" target="_blank" class="social-link">
            💼 LinkedIn
        </a>
        <a href="https://github.com/Amit-Singh3" target="_blank" class="social-link">
            🐙 GitHub
        </a>
        <a href="https://leetcode.com/u/amitcheharwal/" target="_blank" class="social-link">
            🌐 Leetcode
        </a>
    </div>
